...
export const SOURCES = [
  ...
  { name: 'TechCrunch AI', url: 'https://techcrunch.com/category/artificial-intelligence/feed/', tags: ['industry', 'news'] },
  { name: 'VentureBeat AI', url: 'https://venturebeat.com/category/ai/feed/', tags: ['industry', 'news'] },
  { name: 'The Verge AI', url: 'https://www.theverge.com/ai-artificial-intelligence/rss/index.xml', tags: ['news'] },
  { name: 'Wired AI', url: 'https://www.wired.com/feed/tag/ai/latest/rss', tags: ['news'] },
  { name: 'Meta AI Blog', url: 'https://ai.meta.com/blog/feed/', tags: ['research', 'meta'] },
  { name: 'Microsoft AI Blog', url: 'https://blogs.microsoft.com/ai/feed/', tags: ['industry', 'microsoft'] },
];
